        ...
        <div className={`relative w-full rounded-2xl overflow-hidden mb-8 min-h-[280px] shadow-2xl ${className}`}>
            ...
            <div className="relative h-full flex items-center px-8 sm:px-12 py-12">
                <div className="max-w-2xl">
                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-[#FFCA00]/10 border border-[#FFCA00]/30 text-[#FFCA00] text-[10px] font-black uppercase tracking-[0.2em] mb-4">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-display font-black text-white tracking-tighter mb-4 leading-tight">
                        24/7 Priority <br />
                ...
                <div className="ml-auto hidden md:block">
                    <Button 
                        size="lg"
                        className="bg-[#FFCA00] hover:bg-[#FFCA00]/90 text-navy-900 font-bold px-8 h-14 rounded-xl shadow-xl transition-all hover:-translate-y-1 flex items-center gap-3 border-none"
                    >
