...
const Sidebar: React.FC<SidebarProps> = ({ isOpen = false, onClose }) => {
    ...
    return (
        <>
            ...
            {/* Sidebar Content */}
            <aside
                className={`fixed left-0 top-0 h-screen w-72 bg-[#003399] flex flex-col py-8 px-4 z-50 md:translate-x-0 overflow-hidden transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
